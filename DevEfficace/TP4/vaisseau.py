...
class Vaisseau:
    ...
    def dessine(self, s_persistante, s_temp):
        ...
        if self.sprite:
            ...
            pygame.draw.rect(s_temp, self.couleur, (int(x)-20, int(y)-20, 40, 40))
            pygame.draw.rect(s_temp, pygame.Color("white"), (int(x)-10, int(y)-10, 20, 20))
