...
class Planete:
    ...
    def dessine(self, s_persistante, s_temp):
        ...
        for sat in self.satellite:
            sat.centre_orbite = (x, y)
            sat.dessine(s_persistante, s_temp)
    ...
    def add_satellite(self, taille, rayon_orbite, v_angulaire,  
    couleur, trace=False, phase=0):
        new_satellite = Planete(taille,rayon_orbite,self.centre_orbite,v_angulaire,couleur,trace,phase)
        self.satellite.append(new_satellite)
